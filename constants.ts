    ...
    sessions: [
      ...
      },
      {
        ...
        speakers: [
          ...
          { name: 'Frederikke Saabye', company: 'Dansk Erhverv', role: 'Acting Industry Director for Digitalization, Technology & Telecom', image: getSpeakerImage('Frederikke Saabye'), bio: "Frederikke Saabye has held key leadership roles in driving digital policy at the Danish Chamber of Commerce, most recently as Acting Director for Digitalisation, Technology & Telecom. She has been an active voice in national debates on digital sovereignty and cyber security, contributing to expert panels and events focused on strengthening Denmark's digital resilience. With a Master of European Affairs from Lund University, she combines deep technological insight with strong European policy expertise." }
        ]
      },
      {
        id: 'wed-9',
